                  ...
                  <div className="w-[80%]  h-full  flex justify-center ">
                    <div className="relative z-10 h-full w-full mb-4 flex items-center justify-center overflow-hidden   ">
                      <img
                        ...
                        src="src\assets\images\hero\Creative team-cuate.png"
                        alt=""
                      />
                      <div>
      ...
      >
        <div class="container px-4">
          <div class=" flex flex-wrap items-center justify-center gap-8 xl:gap-11">
            ...
            <img
              src="src\assets\images\logo\bang_jamin.png"
              alt="graygrids"
              class="dark:hidden w-40"
            />

            <img
              src="src\assets\images\logo\mezocliq-1.png"
              alt="lineicons"
              class="dark:hidden"
            />
            <img
              src="src\assets\images\logo\zimble_code.png"
              alt="graygrids"
            ...
            <img
              src="src\assets\images\logo\digispice.png"
              alt="ayroui"
              class="dark:hidden w-40"
            />
            <img
